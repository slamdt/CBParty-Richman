...
void Animation::play(const char *_animationName, int _durationTo, int _durationTween,  int _loop, int _tweenEasing)
{
    ...
    _tweenEasing	= (_tweenEasing == SP_TWEEN_EASING_MAX) ? m_pMovementData->getTweenEasing() : _tweenEasing;
...
{
    CCAssert((_animationIndex > -1) && (_animationIndex < m_arrMovNames.size()), "");
